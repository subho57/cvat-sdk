...
export const ServerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        serverListShare: async (directory?: string, search?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ServerApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async serverListShare(directory?: string, search?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<FileInfo>>> {
