...
export const AssetsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        assetsRetrievePublic: async (uuid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'uuid' is not null or undefined
            assertParamExists('assetsRetrievePublic', 'uuid', uuid)
            const localVarPath = `/api/assets/{uuid}/public`
                .replace(`{${"uuid"}}`, encodeURIComponent(String(uuid)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const AssetsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async assetsRetrievePublic(uuid: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AssetRead>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.assetsRetrievePublic(uuid, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const AssetsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        /**
         * 
         * @param {AssetsApiAssetsRetrievePublicRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        assetsRetrievePublic(requestParameters: AssetsApiAssetsRetrievePublicRequest, options?: AxiosRequestConfig): AxiosPromise<AssetRead> {
            return localVarFp.assetsRetrievePublic(requestParameters.uuid, options).then((request) => request(axios, basePath));
        },
    };
};
...
/**
 * Request parameters for assetsRetrievePublic operation in AssetsApi.
 * @export
 * @interface AssetsApiAssetsRetrievePublicRequest
 */
export interface AssetsApiAssetsRetrievePublicRequest {
    /**
     * A UUID string identifying this asset.
     * @type {string}
     * @memberof AssetsApiAssetsRetrievePublic
     */
    readonly uuid: string
}
...
export class AssetsApi extends BaseAPI {
     ...
     * @memberof AssetsApi
     */
    public assetsRetrievePublic(requestParameters: AssetsApiAssetsRetrievePublicRequest, options?: AxiosRequestConfig) {
        return AssetsApiFp(this.configuration).assetsRetrievePublic(requestParameters.uuid, options).then((request) => request(this.axios, this.basePath));
    }
}
