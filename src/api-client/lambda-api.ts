...
export const LambdaApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        lambdaDeleteRequests: async (id: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const LambdaApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async lambdaDeleteRequests(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async lambdaRetrieveFunctions(funcId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
...
export const LambdaApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        lambdaDeleteRequests(requestParameters: LambdaApiLambdaDeleteRequestsRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        lambdaRetrieveFunctions(requestParameters: LambdaApiLambdaRetrieveFunctionsRequest, options?: AxiosRequestConfig): AxiosPromise<object> {
...
export class LambdaApi extends BaseAPI {
     ...
     * @memberof LambdaApi
     */
    public lambdaDeleteRequests(requestParameters: LambdaApiLambdaDeleteRequestsRequest, options?: AxiosRequestConfig) {
