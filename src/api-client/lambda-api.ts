...
export const LambdaApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        lambdaCreateRequests: async (xOrganization?: string, org?: string, orgId?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        lambdaRetrieveRequests: async (id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const LambdaApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async lambdaCreateRequests(xOrganization?: string, org?: string, orgId?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.lambdaCreateRequests(xOrganization, org, orgId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async lambdaListRequests(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async lambdaRetrieveRequests(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const LambdaApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        lambdaCreateRequests(requestParameters: LambdaApiLambdaCreateRequestsRequest = {}, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.lambdaCreateRequests(requestParameters.xOrganization, requestParameters.org, requestParameters.orgId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Method returns a list of functions
         ...
         * @throws {RequiredError}
         */
        lambdaListRequests(options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        lambdaRetrieveRequests(requestParameters: LambdaApiLambdaRetrieveRequestsRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
...
export class LambdaApi extends BaseAPI {
    ...
    public lambdaCreateRequests(requestParameters: LambdaApiLambdaCreateRequestsRequest = {}, options?: AxiosRequestConfig) {
        return LambdaApiFp(this.configuration).lambdaCreateRequests(requestParameters.xOrganization, requestParameters.org, requestParameters.orgId, options).then((request) => request(this.axios, this.basePath));
    }
