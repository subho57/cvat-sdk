...
// @ts-ignore
import type { OrganizationRead } from '../models';
// @ts-ignore
import type { OrganizationWriteRequest } from '../models';
// @ts-ignore
import type { PaginatedOrganizationReadList } from '../models';
// @ts-ignore
import type { PatchedOrganizationWriteRequest } from '../models';
/**
...
export const OrganizationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        organizationsCreate: async (organizationWriteRequest: OrganizationWriteRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        organizationsDestroy: async (id: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {string} [search] A search term. Available search_fields: (\&#39;name\&#39;, \&#39;owner\&#39;, \&#39;slug\&#39;)
         * @param {string} [slug] A simple equality filter for the slug field
         * @param {string} [sort] Which field to use when ordering the results. Available ordering_fields: [\&#39;name\&#39;, \&#39;owner\&#39;, \&#39;slug\&#39;, \&#39;id\&#39;]
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        organizationsList: async (filter?: string, name?: string, owner?: string, page?: number, pageSize?: number, search?: string, slug?: string, sort?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/organizations`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        organizationsPartialUpdate: async (id: number, patchedOrganizationWriteRequest?: PatchedOrganizationWriteRequest, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        organizationsRetrieve: async (id: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const OrganizationsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async organizationsCreate(organizationWriteRequest: OrganizationWriteRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizationRead>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.organizationsCreate(organizationWriteRequest, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OrganizationsApi.organizationsCreate']?.[localVarOperationServerIndex]?.url;
         ...
         * @throws {RequiredError}
         */
        async organizationsDestroy(id: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.organizationsDestroy(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OrganizationsApi.organizationsDestroy']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async organizationsList(filter?: string, name?: string, owner?: string, page?: number, pageSize?: number, search?: string, slug?: string, sort?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PaginatedOrganizationReadList>> {
         ...
         * @throws {RequiredError}
         */
        async organizationsPartialUpdate(id: number, patchedOrganizationWriteRequest?: PatchedOrganizationWriteRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizationRead>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OrganizationsApi.organizationsPartialUpdate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async organizationsRetrieve(id: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizationRead>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.organizationsRetrieve(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OrganizationsApi.organizationsRetrieve']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const OrganizationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        organizationsCreate(requestParameters: OrganizationsApiOrganizationsCreateRequest, options?: RawAxiosRequestConfig): AxiosPromise<OrganizationRead> {
         ...
         * @throws {RequiredError}
         */
        organizationsDestroy(requestParameters: OrganizationsApiOrganizationsDestroyRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        organizationsList(requestParameters: OrganizationsApiOrganizationsListRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<PaginatedOrganizationReadList> {
         ...
         * @throws {RequiredError}
         */
        organizationsPartialUpdate(requestParameters: OrganizationsApiOrganizationsPartialUpdateRequest, options?: RawAxiosRequestConfig): AxiosPromise<OrganizationRead> {
         ...
         * @throws {RequiredError}
         */
        organizationsRetrieve(requestParameters: OrganizationsApiOrganizationsRetrieveRequest, options?: RawAxiosRequestConfig): AxiosPromise<OrganizationRead> {
...
export class OrganizationsApi extends BaseAPI {
     ...
     */
    public organizationsCreate(requestParameters: OrganizationsApiOrganizationsCreateRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof OrganizationsApi
     */
    public organizationsDestroy(requestParameters: OrganizationsApiOrganizationsDestroyRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof OrganizationsApi
     */
    public organizationsList(requestParameters: OrganizationsApiOrganizationsListRequest = {}, options?: RawAxiosRequestConfig) {
     ...
     * @memberof OrganizationsApi
     */
    public organizationsPartialUpdate(requestParameters: OrganizationsApiOrganizationsPartialUpdateRequest, options?: RawAxiosRequestConfig) {
     ...
     * @memberof OrganizationsApi
     */
    public organizationsRetrieve(requestParameters: OrganizationsApiOrganizationsRetrieveRequest, options?: RawAxiosRequestConfig) {
