...
// @ts-ignore
import { AcceptInvitationRead } from '../models';
// @ts-ignore
import { AcceptInvitationWriteRequest } from '../models';
// @ts-ignore
...
export const InvitationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {AcceptInvitationWriteRequest} acceptInvitationWriteRequest 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        invitationsAccept: async (key: string, acceptInvitationWriteRequest: AcceptInvitationWriteRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'key' is not null or undefined
            assertParamExists('invitationsAccept', 'key', key)
            // verify required parameter 'acceptInvitationWriteRequest' is not null or undefined
            assertParamExists('invitationsAccept', 'acceptInvitationWriteRequest', acceptInvitationWriteRequest)
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(acceptInvitationWriteRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        invitationsResend: async (key: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'key' is not null or undefined
...
export const InvitationsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async invitationsAccept(key: string, acceptInvitationWriteRequest: AcceptInvitationWriteRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AcceptInvitationRead>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.invitationsAccept(key, acceptInvitationWriteRequest, options);
         ...
         * @throws {RequiredError}
         */
        async invitationsResend(key: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const InvitationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        invitationsAccept(requestParameters: InvitationsApiInvitationsAcceptRequest, options?: AxiosRequestConfig): AxiosPromise<AcceptInvitationRead> {
            return localVarFp.invitationsAccept(requestParameters.key, requestParameters.acceptInvitationWriteRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Method creates an invitation
         ...
         * @throws {RequiredError}
         */
        invitationsResend(requestParameters: InvitationsApiInvitationsResendRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
...
export interface InvitationsApiInvitationsAcceptRequest {
    ...
    /**
     * 
     * @type {AcceptInvitationWriteRequest}
     * @memberof InvitationsApiInvitationsAccept
     */
    readonly acceptInvitationWriteRequest: AcceptInvitationWriteRequest
}
...
export class InvitationsApi extends BaseAPI {
     ...
     */
    public invitationsAccept(requestParameters: InvitationsApiInvitationsAcceptRequest, options?: AxiosRequestConfig) {
        return InvitationsApiFp(this.configuration).invitationsAccept(requestParameters.key, requestParameters.acceptInvitationWriteRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof InvitationsApi
     */
    public invitationsResend(requestParameters: InvitationsApiInvitationsResendRequest, options?: AxiosRequestConfig) {
