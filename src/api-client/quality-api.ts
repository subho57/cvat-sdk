...
export const QualityApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [filter] A filter term. Available filter_fields: [\&#39;id\&#39;, \&#39;frame\&#39;, \&#39;type\&#39;, \&#39;job_id\&#39;, \&#39;task_id\&#39;, \&#39;severity\&#39;]
         ...
         * @param {string} [xOrganization] Organization unique slug
         * @param {string} [filter] A filter term. Available filter_fields: [\&#39;id\&#39;, \&#39;job_id\&#39;, \&#39;created_date\&#39;, \&#39;gt_last_updated\&#39;, \&#39;target_last_updated\&#39;, \&#39;parent_id\&#39;]
         * @param {number} [jobId] A simple equality filter for the job_id field
         * @param {string} [org] Organization unique slug
         * @param {number} [orgId] Organization identifier
         * @param {number} [page] A page number within the paginated result set.
         ...
         * @param {string} [xOrganization] Organization unique slug
         * @param {string} [filter] A filter term. Available filter_fields: [\&#39;id\&#39;, \&#39;task_id\&#39;]
         * @param {string} [org] Organization unique slug
         * @param {number} [orgId] Organization identifier
         * @param {number} [page] A page number within the paginated result set.
         * @param {number} [pageSize] Number of results to return per page.
...
export const QualityApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async qualityRetrieveReportData(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: any; }>> {
...
export const QualityApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        qualityRetrieveReportData(requestParameters: QualityApiQualityRetrieveReportDataRequest, options?: AxiosRequestConfig): AxiosPromise<{ [key: string]: any; }> {
...
export interface QualityApiQualityListConflictsRequest {
    ...
    /**
     * A filter term. Available filter_fields: [\&#39;id\&#39;, \&#39;frame\&#39;, \&#39;type\&#39;, \&#39;job_id\&#39;, \&#39;task_id\&#39;, \&#39;severity\&#39;]
     * @type {string}
     * @memberof QualityApiQualityListConflicts
     */
...
export interface QualityApiQualityListReportsRequest {
    ...
    /**
     * A filter term. Available filter_fields: [\&#39;id\&#39;, \&#39;job_id\&#39;, \&#39;created_date\&#39;, \&#39;gt_last_updated\&#39;, \&#39;target_last_updated\&#39;, \&#39;parent_id\&#39;]
     * @type {string}
     * @memberof QualityApiQualityListReports
     */
    readonly filter?: string
...
export interface QualityApiQualityListSettingsRequest {
    ...
    /**
     * A filter term. Available filter_fields: [\&#39;id\&#39;, \&#39;task_id\&#39;]
     * @type {string}
     * @memberof QualityApiQualityListSettings
     */
    readonly filter?: string
